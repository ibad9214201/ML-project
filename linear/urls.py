...
from MLapp.views import Decisiontree, Decisiontree_load_data, Edit_Data, GradientBoosting, Gradientclass, House_price, XgboostClassification, XgboostRegressor, delete_employee, mainhtml, poly_nomial, poly_predict, predictvalue, update_Data
...
urlpatterns = [
    ...
    path('Gradientclass/',Gradientclass,name="Gradientclass"),
    path('XgboostRegressor/',XgboostRegressor,name="XgboostRegressor"),
    path('XgboostClassification/',XgboostClassification,name="XgboostClassification")
